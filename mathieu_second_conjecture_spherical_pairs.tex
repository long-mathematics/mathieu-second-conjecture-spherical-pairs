...
Lemma~\ref{lem:subdirect} does not use sphericity and does not require a bound on block sizes. In the residual analysis sphericity is used only in Lemma~\ref{lem:projection}, to exclude finite projections of the stabilizer. In particular, neither the classification of spherical subgroups of $\SL_2^r$ nor spherical-root localization is needed.
\end{remark}
